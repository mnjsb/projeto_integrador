...
while True: # Mostra o menu de opções até que o usuário digite [0] para finalizar o programa
    ...
    if escolha == '1': # Condicional que recebe a opção [1] escolhida pelo usuário na variável "escolha"
        print("\nVocê escolheu opção [1] converter Celsius -> Fahrenheit\n") 
        ...
        print("\nVocê escolheu opção [2] converter Celsius -> Kelvin\n")
        ...
        print("\nVocê escolheu opção [3] converter Celsius -> Réamur\n")
        ...
        print("\nVocê escolheu opção [4] converter Fahrenheit -> Celsius\n")
        ...
        print("\nVocê escolheu opção [5] converter Fahrenheit -> Kelvin\n")
        ...
        print("\nVocê escolheu opção [6] converter Fahrenheit -> Réamur\n")
        ...
        print("\nVocê escolheu opção [7] converter Kelvin -> Celsius\n")
        ...
        print("\nVocê escolheu opção [8] converter Kelvin -> Fahrenheit\n")
        ...
        print("\nVocê escolheu opção [9] converter Kelvin -> Réamur\n")
        ...
        print("\nVocê escolheu opção [10] converter Réamur -> Celsius\n")
        ...
        print("\nVocê escolheu opção [11] converter Réamur -> Fahrenheit\n")
        ...
        print("\nVocê escolheu opção [12] converter Réamur -> Kelvin\n")
        ...
        print("\nOpção Inválida! Digite [0] para finalizar ou tente novamente!\n")
